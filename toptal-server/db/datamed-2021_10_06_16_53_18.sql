...
CREATE TABLE `doctorHasEducation` (
  ...
  CONSTRAINT `doctorHasEducation_education_id_fk` FOREIGN KEY (`educationId`) REFERENCES `educations` (`id`),
...
INSERT INTO `users` VALUES ('b2d340e1-e67a-46df-9b06-ac3d13438613','alexiialin96@gmail.com','$2b$10$Ehctb449TDnaqvnwyDExTe5adw9S33lUNnCE9yP/o5DOFX3ybiQvO',1,'1996-11-02',NULL,NULL);
...
-- Dump completed on 2021-10-06 16:53:18
